...
public class CameraController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //if (SnakeManage.GetInstance().GetSnakeList()[0] != null)
        //{
        //    //transform.position = SnakeManage.GetInstance().GetSnakeList()[0].transform.localPosition;//new Vector3(0f, 0f + Time.deltaTime * 70f, 0f);//改变相机的位置
        //    //Debug.Log("=====================x==========================" + SnakeManage.GetInstance().GetSnakeList()[0].transform.localPosition.x);
        //    //Debug.Log("=====================y==========================" + SnakeManage.GetInstance().GetSnakeList()[0].transform.localPosition.y);
        //    transform.localPosition = new Vector3(0f, SnakeManage.GetInstance().GetSnakeList()[0].transform.localPosition.y);
        //}
    }
}
